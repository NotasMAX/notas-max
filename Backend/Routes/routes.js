...
routes.get('/Simulado/:simulado_id/Disciplina/:disciplina_id', SimuladosController.getSimuladoDisciplinaAlunos);
...
routes.get('/Professor/:professor/data/anoAtual', SimuladosController.getProfessorDataCurrentYear);
