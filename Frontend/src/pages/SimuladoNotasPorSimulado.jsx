...
import { getByAlunoAndBimestre, getOne } from '../api/simuladoApi.js';
    ...
    return (
        <div className='flex flex-col gap-y-2'>
            <div className={StyleTitle.titleContent}>
                <div>
                    <h1 className={StyleTitle.titlePage}>Notas Aluno(a) - {aluno.nome}</h1>
                    <p className={StyleTitle.subtitlePage}>Lista com o números de acertos, separado pelas materias</p>
                </div>

                <div>
                    <BimestreAtual bimestre={simulados[0]?.bimestre} ano={simulados[0]?.turma.ano} />
                </div>
            </div>
            ...
            <div className="flex gap-3">
                ...
                <button className={ButtonStyle.buttonSecondarySmall} onClick={() => (navigate())}>
                    ...
                    Editar Acertos do Aluno</button>
            </div>
            ...
            <div className={ButtonStyle.formSelectContainer}>
                ...
                <svg className={ButtonStyle.formSelectArrowRight} width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex flex-col gap-y-1">
                {simulados.find(s => s._id === simuladoId)?.conteudos?.map((conteudo, index) => (
                    <NotasCard
            ...
            < div className="flex items-center justify-end" >
                <div className="flex justify-end gap-3">
                    <button className={ButtonStyle.buttonSecondary} onClick={() => (navigate(-1))}>Voltar a lista de alunos</button>

                    <button className={ButtonStyle.buttonPrimary} onClick={() => (navigate(`/Simulados/Notas/Materia/${simuladoId}/${bimestre}/${alunoId}`))}>

                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M7 4C5.34315 4 4 5.34315 4 7V17C4 18.6569 5.34315 20 7 20H17C18.6569 20 20 18.6569 20 17V13C20 12.4477 20.4477 12 21 12C21.5523 12 22 12.4477 22 13V17C22 19.7614 19.7614 22 17 22H7C4.23858 22 2 19.7614 2 17V7C2 4.23858 4.23858 2 7 2H11C11.5523 2 12 2.44772 12 3C12 3.55228 11.5523 4 11 4H7Z" fill="white" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M21.7071 2.29289C22.0976 2.68342 22.0976 3.31658 21.7071 3.70711L12.7071 12.7071C12.3166 13.0976 11.6834 13.0976 11.2929 12.7071C10.9024 12.3166 10.9024 11.6834 11.2929 11.2929L20.2929 2.29289C20.6834 1.90237 21.3166 1.90237 21.7071 2.29289Z" fill="white" />
                            <path fillRule="evenodd" clipRule="evenodd" d="M14 3C14 2.44772 14.4477 2 15 2H21C21.5523 2 22 2.44772 22 3V9C22 9.55228 21.5523 10 21 10C20.4477 10 20 9.55228 20 9V4H15C14.4477 4 14 3.55228 14 3Z" fill="white" />
                        </svg>
