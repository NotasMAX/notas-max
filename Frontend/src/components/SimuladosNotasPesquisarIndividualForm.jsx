...
export default function SimuladosNotasPesquisarForm({ onSubmit, simulados, simulado, turma_id, aluno_id }) {
    ...
    const handleChange = (e) => {
        ...
        if (value !== simulado?._id) {
            confirmDialog({
                message: `Tem certeza de que deseja alterar o simulado neste momento? O processo não salvará as alterações.`,
                header: 'Confirmação',
                ...
                rejectLabel: 'Não',
                accept: () => {
                    navigate(`/Turmas/${turma_id}/Aluno/${aluno_id}/Simulado/${value}/Notas/`, { replace: true, state: { message: 'Simulado alterado com sucesso', type: 'success' } });
                },
                reject: () => {
                }
            }
        ...
        <form className={Style.formContainer} onSubmit={handleSubmit}>
            ...
            <div className={Style.formContainerOption}>
                ...
                <div className={Style.formSelectContainer}>
                    ...
                    >
                        {simulados ? simulados.map((simulado, index) => (
