...
export default function SimuladoAlunoItem({ alunoResultado, numerosQuestoes }) {
    return (
        <div className={Style.ListRow + " " + Style.ListCol4}>
            <div className={Style.ListCol4}>
                {alunoResultado.aluno.nome}
            </div>

            <div>
                {alunoResultado.timestamp}
            </div>

            <div>
                {alunoResultado.resultado} / {numerosQuestoes}
            </div>
            <div>
                <button className={Button.buttonSquare}>
